...
public class MyFilteredLearner {
	...
	public void evaluate() {
		try {
			...
			System.out.println(trainData.attribute(0).toString());
	...
	public void learn() {
		File stopwords = null;
		try {
			stopwords = new File("C:/Users/Otthon/Desktop/stopwords.txt");
			trainData.setClassIndex(0);
			filter = new StringToWordVector();
			filter.setAttributeIndices("last");
	 ...
	 */
	public static void makeLearner () {

		MyFilteredLearner learner;
		learner = new MyFilteredLearner();
		learner.loadDataset("/Users/huszarcsaba/Desktop/davidshit.arff");
		// Evaluation mus be done before training
		// More info in: http://weka.wikispaces.com/Use+WEKA+in+your+Java+code
		learner.evaluate();
		learner.learn();
		learner.saveModel("/Users/huszarcsaba/Desktop/davidshit.model");
	}
}	